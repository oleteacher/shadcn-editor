...
export const localTypeToShadcn: Record<z.infer<typeof registryItemTypeSchema>, z.infer<typeof registryItemTypeSchema>> = {
  'registry:block': 'registry:block',
  'registry:context': 'registry:component',
  'registry:hook': 'registry:hook',
  'registry:node': 'registry:component',
  'registry:plugin': 'registry:component',
  'registry:shared': 'registry:lib',
  'registry:theme': 'registry:theme',
  'registry:transformer': 'registry:lib',
  'registry:ui': 'registry:ui',
  'registry:util': 'registry:lib',
